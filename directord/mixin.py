...
class Mixin(object):
    ...
    def format_action(
        ...
        :type targets: List
        :param args: Argument dictionary, used to set arguments in dictionary
        ...
        component_kwargs = dict(exec_string=execute, data=data, arg_vars=args)
